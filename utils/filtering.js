...
/* const filtering = (category, from, to, region) => {
  ...
  if (category) filtering.category = category;
  if (from) filtering.amount = { ...filtering.amount, $gte: from };
  if (to) filtering.amount = { ...filtering.amount, $lte: to };
  if (region) filtering.region = region;
